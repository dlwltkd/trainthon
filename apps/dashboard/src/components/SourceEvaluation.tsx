...
export function SourceEvaluations() {
  ...
  if (!evaluations.length) return <Panel className="p-6"><div className="font-semibold">Measured source evaluations</div><p className="mt-2 text-ink-2">Run the fixed 20-task development set or the separate CVEfixes source pilot. Results appear after a real execution starts.</p><pre className="mt-4 overflow-x-auto rounded-lg bg-canvas p-3 text-[0.85em]">pnpm cli eval --suite development20</pre></Panel>;
